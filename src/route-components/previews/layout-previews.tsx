...
export const FooterPreview: React.FC = () => {
  ...
  const extraControls = (
    <div className="flex flex-col gap-4 w-full mt-4 border-t border-border/50 pt-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] md:grid-cols-[150px_1fr] items-start sm:items-center gap-4 w-full">
        ...
        <div className="flex items-center flex-wrap gap-2 p-1.5 bg-muted/30 rounded-xl w-full">
          {(["default", "split", "centered", "minimal"] as const).map(l => (
  ...
  return (
    <PreviewContainer 
      title="Footer" 
      description="A minimal, modern footer component for Future UI with full layout, size, and theme control." 
    ...
    >
      <div className={cn("w-full flex items-end min-h-[400px] mt-auto transition-colors duration-300 rounded-b-2xl overflow-hidden", previewVariant === "ghost" && "bg-muted/30")}>
        <Footer 
          color={previewColor} 
